                  ...
                  <div className="row">
                    <div className="col-6 col-12-small">
                      <section className="box">
                        ...
                        <p>Lorem ipsum dolor sit amet sit veroeros sed et blandit consequat sed veroeros lorem et
                          blandit adipiscing feugiat phasellus tempus hendrerit, tortor vitae mattis tempor, sapien sem
                          feugiat sapien, id suscipit magna felis nec elit. Class aptent taciti sociosqu ad litora
                          torquent per conubia nostra, per inceptos lorem ipsum dolor sit amet.</p>
                        <footer>
                          <ul className="actions">
            ...
            <div className="row">
              ...
              <div className="col-4 col-12-medium">
                <section>
                  ...
                  <p>
                    ...
                    the <a href="http://html5up.net/license/">Creative Commons Attribution</a> license so feel free to
                    use it for any personal or commercial project &ndash; just don't forget to credit us!
                  </p>
                  <footer>
                    <ul className="actions">
              ...
              <div className="col-4 col-12-medium">
                <section>
                  ...
                  <ul className="social">
                    <li><a className="icon brands fa-facebook-f" href="#"><span className="label">Facebook</span></a>
                    </li>
                    ...
                    <li><a className="icon brands fa-linkedin-in" href="#"><span className="label">LinkedIn</span></a>
                    </li>
                  </ul>
